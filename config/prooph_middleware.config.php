...
/**
 * This file contains default configuration for prooph/http-middleware
...
return [
    ...
    'prooph' => [
        ...
        'middleware' => [
            //This section will be used by \Prooph\HttpMiddleware\Container\QueryMiddlewareFactory
            'query' => [
                // container/service id / instance to return the data
                // see \Prooph\HttpMiddleware\Response\ResponseStrategy for an example
                ...
                // 'metadata_gatherer' => \Prooph\HttpMiddleware\MetadataGatherer::class
            ],
            //This section will be used by \Prooph\HttpMiddleware\Container\CommandMiddlewareFactory
            'command' => [
            ...
            //This section will be used by \Prooph\HttpMiddleware\Container\EventMiddlewareFactory
            'event' => [
                // container/service id, see \Prooph\Common\Messaging\MessageFactory for more details
                'message_factory' => \Prooph\Common\Messaging\FQCNMessageFactory::class,
            ...
            //This section will be used by \Prooph\HttpMiddleware\Container\MessageMiddlewareFactory
            'message' => [
                // container/service id to return the data
                // see \Prooph\HttpMiddleware\Response\ResponseStrategy for an example, only used for query bus
                'response_strategy' => 'custom_response_strategy',
                // container/service id, see \Prooph\Common\Messaging\MessageFactory for more details
